...
--- chrome/browser/component_updater/widevine_cdm_component_installer.cc.orig	2024-03-26 21:36:37.671936800 +0000
...
@@ -78,7 +78,7 @@ static_assert(std::size(kWidevineSha2Has
...
@@ -364,7 +364,7 @@ void WidevineCdmComponentInstallerPolicy
     return;
   }
