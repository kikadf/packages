...
@@ -572,6 +576,7 @@ size_t SegmentSpanLength(base::span<cons
   return sum;
 }
...
@@ -596,6 +601,7 @@ absl::optional<QRCodeGenerator::Generate
...
@@ -613,9 +619,11 @@ QRCodeGenerator::GeneratedCode::~Generat
