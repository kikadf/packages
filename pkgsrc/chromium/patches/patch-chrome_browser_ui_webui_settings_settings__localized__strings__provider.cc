...
--- chrome/browser/ui/webui/settings/settings_localized_strings_provider.cc.orig	2024-04-30 23:46:48.462890000 +0000
...
@@ -433,7 +433,7 @@ void AddAppearanceStrings(content::WebUI
...
+#if (BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)) && !BUILDFLAG(IS_CHROMEOS_LACROS)
 ...
 #endif
 #if BUILDFLAG(IS_MAC)
@@ -468,7 +468,7 @@ void AddAppearanceStrings(content::WebUI
