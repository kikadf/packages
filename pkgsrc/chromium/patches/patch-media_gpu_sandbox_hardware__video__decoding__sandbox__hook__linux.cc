...
--- media/gpu/sandbox/hardware_video_decoding_sandbox_hook_linux.cc.orig	2024-03-19 22:14:49.211501100 +0000
...
+#if !BUILDFLAG(IS_BSD)
 void AllowAccessToRenderNodes(std::vector<BrokerFilePermission>& permissions,
                               ...
                               bool read_write) {
@@ -166,6 +169,7 @@ bool HardwareVideoDecodingPreSandboxHook
   NOTREACHED_NORETURN();
...
@@ -181,6 +185,7 @@ bool HardwareVideoDecodingPreSandboxHook
 //   (at least).
