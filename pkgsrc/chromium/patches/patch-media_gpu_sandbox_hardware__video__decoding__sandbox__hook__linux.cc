...
--- media/gpu/sandbox/hardware_video_decoding_sandbox_hook_linux.cc.orig	2024-05-09 21:46:58.483362000 +0000
...
+#if !BUILDFLAG(IS_BSD)
 void AllowAccessToRenderNodes(std::vector<BrokerFilePermission>& permissions,
                               ...
                               bool read_write) {
@@ -182,6 +185,7 @@ bool HardwareVideoDecodingPreSandboxHook
   NOTREACHED_NORETURN();
...
@@ -197,6 +201,7 @@ bool HardwareVideoDecodingPreSandboxHook
 //   (at least).
