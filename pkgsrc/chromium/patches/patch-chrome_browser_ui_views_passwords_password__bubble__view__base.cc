...
--- chrome/browser/ui/views/passwords/password_bubble_view_base.cc.orig	2024-06-13 23:28:50.475285500 +0000
...
@@ -132,7 +132,7 @@ PasswordBubbleViewBase* PasswordBubbleVi
   } else if (model_state ==
