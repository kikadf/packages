...
--- third_party/maldoca/src/maldoca/service/common/process_doc_wrapper.cc.orig	2024-05-21 22:43:30.964095000 +0000
...
+  #if defined(OS_LINUX) || BUILDFLAG(IS_BSD)
   ...
   #else
@@ -74,7 +74,7 @@ void AnalyzeOfficeDocument(base::File of
