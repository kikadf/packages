...
--- third_party/ffmpeg/chromium/scripts/robo_lib/config.py.orig	2024-03-19 22:15:37.071771000 +0000
...
@@ -185,6 +179,12 @@ class RoboConfiguration:
...
@@ -193,8 +193,8 @@ class RoboConfiguration:
     wd = os.getcwd()
