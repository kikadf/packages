...
--- media/gpu/chromeos/libyuv_image_processor_backend.cc.orig	2024-03-19 22:14:49.175498000 +0000
...
@@ -434,7 +434,7 @@ int LibYUVImageProcessorBackend::DoConve
...
@@ -595,7 +595,7 @@ int LibYUVImageProcessorBackend::DoConve
     }
   }
