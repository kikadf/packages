...
--- components/feature_engagement/public/feature_constants.cc.orig	2024-03-06 00:14:47.254525200 +0000
...
@@ -610,7 +610,7 @@ constexpr base::FeatureParam<int> kDefau
     /*default_value=*/365};
...
@@ -736,7 +736,7 @@ BASE_FEATURE(kIPHScalableIphGamingFeatur
