...
--- media/base/media_switches.cc.orig	2024-04-10 21:24:55.961541400 +0000
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -743,7 +743,7 @@ BASE_FEATURE(kGlobalMediaControlsUpdated
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -755,7 +755,7 @@ BASE_FEATURE(kMediaRemotingWithoutFullsc
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -1466,7 +1466,7 @@ BASE_FEATURE(kUseOutOfProcessVideoDecodi
 );
