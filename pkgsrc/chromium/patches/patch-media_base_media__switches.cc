...
--- media/base/media_switches.cc.orig	2024-04-15 20:34:00.978360700 +0000
...
@@ -363,8 +363,8 @@ BASE_FEATURE(kMacLoopbackAudioForScreenS
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -741,7 +741,7 @@ BASE_FEATURE(kGlobalMediaControlsUpdated
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -753,7 +753,7 @@ BASE_FEATURE(kMediaRemotingWithoutFullsc
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -1033,7 +1033,7 @@ BASE_FEATURE(kLiveCaptionSystemWideOnChr
