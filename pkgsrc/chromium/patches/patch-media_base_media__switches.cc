...
--- media/base/media_switches.cc.orig	2024-05-21 22:43:04.813763000 +0000
...
@@ -60,8 +60,12 @@ const char kDisableBackgroundMediaSuspen
...
@@ -363,8 +367,8 @@ BASE_FEATURE(kMacLoopbackAudioForScreenS
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -727,7 +731,7 @@ BASE_FEATURE(kGlobalMediaControlsUpdated
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -739,7 +743,7 @@ BASE_FEATURE(kMediaRemotingWithoutFullsc
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -1024,7 +1028,7 @@ BASE_FEATURE(kLiveCaptionSystemWideOnChr
...
+#if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_BSD)
 ...
 #else
              base::FEATURE_DISABLED_BY_DEFAULT
@@ -1487,7 +1491,7 @@ BASE_FEATURE(kUseGTFOOutOfProcessVideoDe
              base::FEATURE_DISABLED_BY_DEFAULT);
