...
--- chrome/browser/chrome_browser_main.cc.orig	2024-04-15 20:33:46.701312000 +0000
...
@@ -523,7 +523,7 @@ void ProcessSingletonNotificationCallbac
   }
 #endif
...
@@ -1089,7 +1089,7 @@ int ChromeBrowserMainParts::PreCreateThr
...
@@ -1137,7 +1137,7 @@ int ChromeBrowserMainParts::PreCreateThr
 // TODO(crbug.com/1052397): Revisit the macro expression once build flag switch
 // of lacros-chrome is complete.
 #if BUILDFLAG(IS_WIN) || BUILDFLAG(IS_MAC) || BUILDFLAG(IS_LINUX) || \
-    BUILDFLAG(IS_CHROMEOS_LACROS) || BUILDFLAG(IS_FUCHSIA)
