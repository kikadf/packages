...
--- chrome/common/media/cdm_registration.cc.orig	2024-05-21 22:42:54.580850100 +0000
...
@@ -60,7 +60,7 @@ using Robustness = content::CdmInfo::Rob
 #if BUILDFLAG(ENABLE_WIDEVINE)
...
@@ -105,7 +105,7 @@ std::unique_ptr<content::CdmInfo> Create
...
@@ -171,7 +171,7 @@ void AddSoftwareSecureWidevine(std::vect
...
@@ -429,7 +429,7 @@ void RegisterCdmInfo(std::vector<content
